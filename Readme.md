...
```yaml
role:       Discord Bot Developer & Founder
company:    Sanerex Development
building:   AeroNova · Zenvora · LoveBiteSupport
stack:      discord.js v14 · Node.js · Python · better-sqlite3
deploys_on: Pterodactyl · DigitalOcean
status:     shipping features, breaking prod occasionally
```
...
<img src="https://skillicons.dev/icons?i=js,nodejs,python,discordjs,sqlite,express,git,vscode&theme=dark" />
